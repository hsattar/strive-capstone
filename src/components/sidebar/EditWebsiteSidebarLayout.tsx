...
export default function EditWebsiteSidebarLayout() {
    ...
    const createLayoutTemplate = (template: blockTemplateOptions) => {
        ...
        <div className="select-none overflow-y-scroll">
            <CustomSidebarDropdown name="Grid - Simple">
                <div className="grid grid-cols-2 justify-center gap-3 p-3">
                    <img onClick={() => handleAddCode(createLayoutTemplate('layout_2x1_1'))} src="/assets/2x1.jpg" className="h-16 hover:border-2 hover:cursor-pointer p-2" alt="2x1" />
