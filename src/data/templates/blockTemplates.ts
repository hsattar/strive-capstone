const blockTemplates = {
    ...
    testimonialCards: [{
        ...
        tag: `<div className="grid md:grid-cols-2 gap-4 bg-gray-100 pt-6 pb-6 pr-8 pl-8 hover:border-2 hover:border-blue-300 hover:cursor-grab">`,
        className: `grid md:grid-cols-2 gap-4 bg-gray-100 pt-6 pb-6 pr-8 pl-8 hover:border-2 hover:border-blue-300 hover:cursor-grab`,
        bgColor: `bg-gray-100`,
        marginT: ``,
        marginR: ``,
        marginB: ``,
        ...
        className: `<div className="bg-white text-center p-4 rounded-md flex items-center`,
        bgColor: `bg-white`,
        marginT: ``,
        marginR: ``,
        marginB: ``,
        ...
        className: `<div className="flex flex-col w-1/4 items-center`,
        bgColor: ``,
        marginT: ``,
        marginR: ``,
        marginB: ``,
        ...
        className: `<div className="flex flex-col text-center w-full`,
        bgColor: ``,
        marginT: ``,
        marginR: ``,
        marginB: ``,
